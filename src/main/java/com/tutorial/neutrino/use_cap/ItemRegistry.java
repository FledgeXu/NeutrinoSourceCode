...
public class ItemRegistry {
    ...
    public static RegistryObject<Item> obsidianTrash = ITEMS.register("obsidian_trash", () -> {
        return new BlockItem(BlockRegistry.obsidianTrash.get(), new Item.Properties().group(ModGroup.itemGroup));
    });
}

...
public class DiamondHouseTemplate extends ScatteredStructurePiece {
    private static final DiamondHouseTemplate.Selector MOSS_STONE_SELECTOR = new DiamondHouseTemplate.Selector();

    protected DiamondHouseTemplate(Random random, int x, int z) {
        super(ServerServerHandler.type, random, x, 64, z, 12, 10, 15);
    }

    protected DiamondHouseTemplate(TemplateManager templateManager, CompoundNBT nbt) {
        super(ServerServerHandler.type, nbt);
    }
